...
const Sidebar = () => {
  ...
  const [menuItems, setMenuItems] = createSignal([
    { name: 'Dashboard', type: 'parent', sub: false, icon: <AiFillHome />, path: '/' },
    { name: 'Artikel', type: 'parent', sub: true, icon: <AiFillHome />, path: '/' }, // ketika klik ini sub menu nya dropdown

    { name: 'Daftar Artikel', type: 'child', parent: 'Artikel', icon: <AiFillFileText />, path: '/artikel' },
    { name: 'Buat Artikel', type: 'child', parent: 'Artikel', icon: <AiFillFileText />, path: '/artikel/create' },
    { name: 'Kategori Produk', type: 'child', parent: 'Artikel', icon: <BsListNested/>, path: '/kategori' },
    { name: 'Tag', type: 'child', parent: 'Artikel', icon: <AiOutlineNumber />, path: '/tag' },

    { name: 'FAQ', type: 'parent', sub: false, icon: <AiOutlineQuestionCircle />, path: '/faq' },
    { name: 'Settings', type: 'parent', sub: false, icon: <AiOutlineSetting />, path: '/setting' },
  ]);
